...
var templateList*: array[15, string] = ["basic_block", "light_block", "crafting_block (exp mode)", "place_code_block (exp mode)",
 "player_code_block (exp mode)", "click_block (exp mode)", "skull_block (exp mode)", "slab_block (exp mode)", "stair_block (exp mode)",
 "old_item", "func_item (exp mode)", "new_item (exp mode)", "dummy_entity", "base_entity", "zombie_entity"]

var templateCheckList*: array[15, string] = ["basic_block", "light_block", "crafting_block", "place_code_block",
 "player_code_block", "click_block", "skull_block", "slab_block", "stair_block",
