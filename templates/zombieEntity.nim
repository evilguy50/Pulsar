...
proc zombieEntity*(name: string, root: string, works: string, nameCount: int, nameNumber: int)=
  ...
  var zombieFileName = "./templates/BP/zombieEntity.txt"
  ...
  var zombieLootFile = "./templates/BP/zombieEntity_loot.txt"
  ...
  var zombieFileName2 = "./templates/RP/zombieEntity.txt"
  ...
  var zombieFileName3 = "./templates/RP/zombieEntity_geo.txt"
  ...
  var zombieRenderFile = "./templates/RP/zombieEntity_render.txt"
  ...
  var zombieTexture = "./templates/RP/textures/zombieEntity.png"
